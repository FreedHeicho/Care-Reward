...
### ✓ PRE-001 — Database connectivity (29ms)

✓ Database responds to query

### ✓ PRE-002 — Schema — all tables exist (6ms)
...
### ✓ PRE-004 — Seed data — opportunities exist (2ms)
...
### ✓ UAT-010 — HSA YTD does not exceed yearly limit (1ms)
...
### ✓ UAT-020 — No user has more than 1 active insurance plan (4ms)
...
### ✓ UAT-016 — Audit logs exist and are populated (2ms)
...
### ✓ UAT-019 — No orphaned records in any child table (16ms)
...
### ✓ UAT-PTYPES — All transaction types are valid (1ms)
...
### ✓ UAT-ENUM — All opportunity categories are valid (1ms)
