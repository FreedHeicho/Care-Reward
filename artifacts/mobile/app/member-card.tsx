...
const styles = StyleSheet.create({
  ...
  cardHeaderLabel: { color: "#FFFFFF", fontSize: 12, fontWeight: "600" },
  ...
  fieldLabel: { fontSize: 9, fontWeight: "700", color: "#586474", letterSpacing: 0.8 },
  ...
  benefitLabel: { fontSize: 8, fontWeight: "700", color: "#586474", letterSpacing: 0.5 },
