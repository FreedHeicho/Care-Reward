...
// ─── Static data (will be replaced by API — see Task #4) ─────────────────────
...
interface CareSiteGroup {
  id: string;
  procedure: string;
  providers: Provider[];
}

const CARE_SITE_GROUPS: CareSiteGroup[] = [
  {
    id: "csg-1",
  ...
  },
  {
    ...
    providers: [
      {
        id: "p7",
        name: "New York Presbyterian hospital (Dr sun)",
        distance: "2.5 miles away",
        points: 0,
      },
      {
        id: "p8",
        name: "NY Langone (Dr. Perrone)",
        distance: "3.8 miles away",
        points: 20,
      },
      {
        id: "p9",
        name: "NY Health & Hospital (IP Dr. Cohen)",
        distance: "5.2 miles away",
        points: 80,
      },
    ],
